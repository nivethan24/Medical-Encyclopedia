...
//		addingNewGraph();
        ...
        //     // console.log("nani ", yearMatchGroupData);
        // });
        // console.log("grouped data", yearGroupedData);
	};
...
function bubbleVisualization(data, type){
    ...
    modifiedData = {"children":modifiedData};
    ...
    node.append("circle")
        ...
        .on("mouseover", function(d) {
            ...
            tooltip.style("top", (d3.event.pageY-10)+"px").style("left",(d3.event.pageX+10)+"px").style("display", "block").style("opacity", "1");
        })
...
function addNetworkGraphs(data, type) {
    ...
    diseaseJsonFormatted = {"links" :[], "nodes":[{"frequency": 40, "group" : 1, "name": data.data.key}]};
    var counter = 0;
    ...
    symptomJsonFormatted = {"links" :[], "nodes":[{"frequency": 40, "group" : 1, "name": data.data.key}]};
    var counter = 0;
